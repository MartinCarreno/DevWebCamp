<footer class="footer">
    <div class="footer__grid">
        ...
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://youtube.com/@martincarreno4192">
                <span class="menu-redes__ocultar">YouTube</span>
            </a> 
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://instagram.com/martini_cv1">
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/MartinCarreno">
